...
using AngularApp.Authorization;
using AngularApp.Helpers;
using AngularApp.OIDC;
using DAL;
using DAL.Core;
...
namespace AngularApp
{
    public class Program
    {
        ...
        private static void AddServices(WebApplicationBuilder builder)
        {
            ...
            var migrationsAssembly = typeof(Program).GetTypeInfo().Assembly.GetName().Name; //AngularApp
        ...
        private static void ConfigureRequestPipeline(WebApplication app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - AngularApp";
